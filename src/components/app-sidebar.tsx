...
import {
	...
	SidebarMenuButton,
	SidebarMenuItem,
	SidebarRail, // Optional: Adds a resizing handle
} from "@/components/ui/sidebar";

const data = {
	user: {
		name: "Deepesh Kakkar",
		email: "deepesh.mgn@gmail.com",
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
	return (
		// 👇 KEY CHANGE: Changed "offcanvas" to "icon".
		<Sidebar collapsible="icon" {...props}>
			...
			{/* Optional: Adds a small rail to the side when collapsed */}
			<SidebarRail />
		</Sidebar>
	);
}
